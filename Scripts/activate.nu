...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Safae\PyCharm\AiVocalAssistant\AiVocalAssistantProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Safae\PyCharm\AiVocalAssistant\AiVocalAssistantProject\Scripts\deactivate.nu'
